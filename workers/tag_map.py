...
# GAAP tag → (line_item, statement). A tag may appear multiple times; keep the first match as the preferred mapping.
TAG_MAP: Dict[str, Tuple[str, str]] = {
    ...
    "us-gaap:RevenueFromContractWithCustomer": ("revenue", "income_statement"),
    "us-gaap:NetSales": ("revenue", "income_statement"),
    "us-gaap:SalesRevenueGoodsGross": ("revenue", "income_statement"),
    "us-gaap:SalesRevenueServicesGross": ("revenue", "income_statement"),
    "us-gaap:RevenuesNetOfInterestExpense": ("revenue", "income_statement"),
    "us-gaap:TotalRevenues": ("revenue", "income_statement"),
    "us-gaap:TotalRevenue": ("revenue", "income_statement"),
    ...
    "us-gaap:CostOfProductsSold": ("cogs", "income_statement"),
    ...
    "us-gaap:TotalOperatingExpenses": ("operating_expenses", "income_statement"),
    ...
    "us-gaap:OperatingIncome": ("operating_income", "income_statement"),
    "us-gaap:IncomeLossFromOperations": ("operating_income", "income_statement"),
    ...
    "us-gaap:InvestmentIncomeInterest": ("interest_income", "income_statement"),
    ...
    "us-gaap:InterestExpenseDebtAndCapitalLeaseObligations": ("interest_expense", "income_statement"),
    ...
    "us-gaap:OtherIncomeExpenseNet": ("other_income_expense", "income_statement"),
    "us-gaap:OtherIncomeExpense": ("other_income_expense", "income_statement"),
    "us-gaap:OtherIncome": ("other_income_expense", "income_statement"),
    "us-gaap:OtherExpense": ("other_income_expense", "income_statement"),
    ...
    "us-gaap:IncomeLossFromContinuingOperationsBeforeIncomeTaxesAndMinorityInterest": (
        "pre_tax_income",
        "income_statement",
    ),
    "us-gaap:IncomeLossFromContinuingOperationsBeforeIncomeTaxesAndNoncontrollingInterest": (
        "pre_tax_income",
        "income_statement",
    ),
    ...
    "us-gaap:ProvisionForIncomeTaxes": ("income_tax_expense", "income_statement"),
    ...
    "us-gaap:NetIncomeLossAttributableToParent": [("net_income", "income_statement"), ("net_income", "cash_flow")],
    ...
    "us-gaap:NetIncomeLossIncludingPortionAttributableToNoncontrollingInterest": [
        ("net_income", "income_statement"),
        ("net_income", "cash_flow"),
    ],
    "us-gaap:IncomeLossFromContinuingOperationsAttributableToParent": [
        ("net_income", "income_statement"),
        ("net_income", "cash_flow"),
    ],
    "us-gaap:ProfitLossAttributableToParent": [("net_income", "income_statement"), ("net_income", "cash_flow")],
    "us-gaap:ProfitLoss": [("net_income", "income_statement"), ("net_income", "cash_flow")],
    "us-gaap:IncomeLossFromContinuingOperations": [("net_income", "income_statement"), ("net_income", "cash_flow")],
    ...
    "us-gaap:EarningsPerShareBasicAndDiluted": ("eps_diluted", "income_statement"),
    ...
    "dei:EntityCommonStockSharesOutstanding": ("shares_outstanding", "income_statement"),
    # Balance sheet
    "us-gaap:Assets": ("assets", "balance_sheet"),
    "us-gaap:AssetsTotal": ("assets", "balance_sheet"),
    ...
    "us-gaap:NoncurrentAssets": ("assets_noncurrent", "balance_sheet"),
    "us-gaap:CashAndCashEquivalentsAtCarryingValue": ("cash", "balance_sheet"),
    "us-gaap:CashEquivalentsAtCarryingValue": ("cash", "balance_sheet"),
    "us-gaap:Cash": ("cash", "balance_sheet"),
    "us-gaap:CashAndCashEquivalents": ("cash", "balance_sheet"),
    "us-gaap:CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents": ("cash", "balance_sheet"),
    "us-gaap:RestrictedCashAndCashEquivalents": ("cash", "balance_sheet"),
    ...
    "us-gaap:MarketableSecurities": ("short_term_investments", "balance_sheet"),
    "us-gaap:AvailableForSaleSecuritiesCurrent": ("short_term_investments", "balance_sheet"),
    "us-gaap:MarketableSecuritiesNoncurrent": ("long_term_investments", "balance_sheet"),
    "us-gaap:AvailableForSaleSecuritiesNoncurrent": ("long_term_investments", "balance_sheet"),
    ...
    "us-gaap:AccountsReceivableNetOfAllowanceForCreditLoss": ("accounts_receivable", "balance_sheet"),
    "us-gaap:AccountsReceivableNetOfAllowanceForDoubtfulAccounts": ("accounts_receivable", "balance_sheet"),
    "us-gaap:AccountsReceivable": ("accounts_receivable", "balance_sheet"),
    "us-gaap:AccountsReceivableCurrent": ("accounts_receivable", "balance_sheet"),
    "us-gaap:AccountsReceivableTradeNet": ("accounts_receivable", "balance_sheet"),
    "us-gaap:InventoryNet": ("inventory", "balance_sheet"),
    "us-gaap:Inventory": ("inventory", "balance_sheet"),
    "us-gaap:PrepaidExpenseAndOtherAssetsCurrent": ("prepaid_expenses", "balance_sheet"),
    "us-gaap:PrepaidExpensesAndOtherCurrentAssets": ("prepaid_expenses", "balance_sheet"),
    ...
    "us-gaap:OtherCurrentAssets": ("other_assets_current", "balance_sheet"),
    "us-gaap:OtherAssetsNoncurrent": ("other_assets_noncurrent", "balance_sheet"),
    "us-gaap:OtherNoncurrentAssets": ("other_assets_noncurrent", "balance_sheet"),
    "us-gaap:PropertyPlantAndEquipmentNet": ("ppe", "balance_sheet"),
    "us-gaap:PropertyPlantAndEquipmentNetIncludingConstructionInProgress": ("ppe", "balance_sheet"),
    "us-gaap:PropertyPlantAndEquipmentNetIncludingCapitalizedInterest": ("ppe", "balance_sheet"),
    ...
    "us-gaap:FiniteLivedIntangibleAssetsNet": ("intangible_assets", "balance_sheet"),
    ...
    "us-gaap:AccruedExpensesAndOtherCurrentLiabilities": ("accrued_expenses", "balance_sheet"),
    "us-gaap:AccruedExpensesCurrent": ("accrued_expenses", "balance_sheet"),
    ...
    "us-gaap:OtherCurrentLiabilities": ("other_liabilities_current", "balance_sheet"),
    "us-gaap:OtherLiabilitiesNoncurrent": ("other_liabilities_noncurrent", "balance_sheet"),
    "us-gaap:OtherNoncurrentLiabilities": ("other_liabilities_noncurrent", "balance_sheet"),
    ...
    "us-gaap:LiabilitiesTotal": ("liabilities", "balance_sheet"),
    "us-gaap:LongTermDebtCurrent": ("debt_current", "balance_sheet"),
    "us-gaap:DebtCurrent": ("debt_current", "balance_sheet"),
    "us-gaap:ShortTermDebt": ("debt_current", "balance_sheet"),
    "us-gaap:ShortTermBorrowings": ("debt_current", "balance_sheet"),
    "us-gaap:CurrentPortionOfLongTermDebt": ("debt_current", "balance_sheet"),
    "us-gaap:LongTermDebtCurrentMaturities": ("debt_current", "balance_sheet"),
    "us-gaap:LongTermDebtNoncurrent": ("debt_long_term", "balance_sheet"),
    "us-gaap:DebtNoncurrent": ("debt_long_term", "balance_sheet"),
    "us-gaap:LongTermDebt": ("debt_long_term", "balance_sheet"),
    ...
    "us-gaap:LongTermBorrowings": ("debt_long_term", "balance_sheet"),
    ...
    "us-gaap:StockholdersEquityTotal": ("equity", "balance_sheet"),
    ...
    "us-gaap:RetainedEarnings": ("retained_earnings", "balance_sheet"),
    ...
    "us-gaap:Depreciation": ("depreciation_amortization", "cash_flow"),
    "us-gaap:AmortizationOfIntangibleAssets": ("depreciation_amortization", "cash_flow"),
    ...
    "us-gaap:IncreaseDecreaseInAccountsReceivable": ("change_accounts_receivable", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccountsReceivableTrade": ("change_accounts_receivable", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccountsReceivableTradeAndOtherReceivables": (
        "change_accounts_receivable",
        "cash_flow",
    ),
    "us-gaap:IncreaseDecreaseInReceivables": ("change_accounts_receivable", "cash_flow"),
    "us-gaap:IncreaseDecreaseInInventory": ("change_inventory", "cash_flow"),
    "us-gaap:IncreaseDecreaseInMerchandiseInventories": ("change_inventory", "cash_flow"),
    "us-gaap:IncreaseDecreaseInInventories": ("change_inventory", "cash_flow"),
    "us-gaap:IncreaseDecreaseInPrepaidExpenses": ("change_prepaid_expenses", "cash_flow"),
    "us-gaap:IncreaseDecreaseInPrepaidExpensesAndOtherAssets": ("change_prepaid_expenses", "cash_flow"),
    "us-gaap:IncreaseDecreaseInOtherCurrentAssets": ("change_other_assets", "cash_flow"),
    "us-gaap:IncreaseDecreaseInOtherOperatingAssets": ("change_other_assets", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccountsPayable": ("change_accounts_payable", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccountsPayableAndAccruedLiabilities": ("change_accounts_payable", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccruedLiabilities": ("change_accrued_expenses", "cash_flow"),
    "us-gaap:IncreaseDecreaseInAccruedLiabilitiesAndOtherOperatingLiabilities": (
        "change_accrued_expenses",
        "cash_flow",
    ),
    "us-gaap:IncreaseDecreaseInDeferredRevenue": ("change_deferred_revenue", "cash_flow"),
    "us-gaap:IncreaseDecreaseInContractWithCustomerLiability": ("change_deferred_revenue", "cash_flow"),
    "us-gaap:IncreaseDecreaseInOtherCurrentLiabilities": ("change_other_liabilities", "cash_flow"),
    "us-gaap:IncreaseDecreaseInOtherOperatingLiabilities": ("change_other_liabilities", "cash_flow"),
    ...
    "us-gaap:PaymentsToAcquirePropertyPlantAndEquipmentAndSoftware": ("capex", "cash_flow"),
    "us-gaap:PaymentsToAcquirePropertyAndEquipment": ("capex", "cash_flow"),
    "us-gaap:CapitalExpenditures": ("capex", "cash_flow"),
    ...
    "us-gaap:DividendsCommonStockCash": ("dividends_paid", "cash_flow"),
    "us-gaap:DividendsPaid": ("dividends_paid", "cash_flow"),
    ...
    "us-gaap:StockRepurchasedAndRetiredDuringPeriodValue": ("share_repurchases", "cash_flow"),
    "us-gaap:PaymentsForRepurchaseOfEquity": ("share_repurchases", "cash_flow"),
